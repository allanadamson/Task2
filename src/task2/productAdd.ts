...
export function initAddProductForm(categories: Category[], suppliers: Supplier[]) {
    ...
    form.addEventListener('submit', (e) => {
        ...
        const categoryId = parseInt((document.getElementById('p-category') as HTMLSelectElement).value);
        const stockRaw = (document.getElementById('p-stock') as HTMLInputElement).value;
        const specsRaw = (document.getElementById('p-specs') as HTMLInputElement).value;
